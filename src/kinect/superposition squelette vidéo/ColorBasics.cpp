...
CColorBasics::CColorBasics() :
	...
	m_hNextSkeletonEvent(INVALID_HANDLE_VALUE), //Imported from skeleton basics
    ...
    m_pBrushBoneInferred(NULL),//All of these imported from skeleton basics
	
    m_pNuiSensor(NULL)
{
	//ZeroMemory(m_Points,sizeof(m_Points)); //from skeleton basics
}
...
CColorBasics::~CColorBasics()
{
    ...
    //DiscardDirect2DResources() ; //Added from Skeleton basics
	delete m_pDrawColor;
    m_pDrawColor = NULL;
...
int CColorBasics::Run(HINSTANCE hInstance, int nCmdShow)
{
    MSG       msg = {0};
    WNDCLASS  wc;
	//WNDCLASS  wc  = {0}; //Added from Skeleton basics, must be tried

    // Dialog custom window class
    ZeroMemory(&wc, sizeof(wc)); //look at line 51
    ...
    //Modified, since we are waiting for 2 events : Skeleton and Color
...
/// </summary>
/// <returns>indicates success or failure</returns>
HRESULT CColorBasics::ProcessColor()
{
    HRESULT hr;
...
/// </summary>
HRESULT CColorBasics::ProcessSkeleton()
{
